...
public class ReloadAddonsCommand implements SubCommand {
	...
	public void execute(BreweryPlugin breweryPlugin, CommandSender sender, String label, String[] args) {
		if (args.length >= 2 && args[1].equalsIgnoreCase("confirm")) {
			...
			breweryPlugin.msg(sender, "&rThis command should be avoided as it can cause unpredictable behavior within addons, use &c/brewery reloadaddons confirm &rto confirm.");
